...
import CategoryNav from "./components-needed/categorynav";
    ...
    <div className="flex sm:hidden">
      <Sheet>
        <SheetTrigger asChild>
          <AlignLeft size={25} strokeWidth={2} />
        </SheetTrigger>
        <SheetContent side="left">
          <div className="grid h-full grid-cols-1 my-16">
            <div className="flex flex-col gap-y-5">
              <CategoryNav />
            </div>

            <Separator className="mt-6" />
            <div className="flex flex-col justify-start mt-5 h-screen">
